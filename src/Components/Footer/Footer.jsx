    ...
    <>
      <footer>
        <div className="row">
          <div className="col">
            ...
            <p className="footer_about">
              Join us in our mission to create a cleaner and more sustainable
              future by responsibly managing e-waste. Schedule your e-waste
              pickup today and be a part of the positive change!
            </p>
          </div>
          <div className="col">
            <h3>
        ...
        <p className="copyright">
          E-waste Locator Ⓒ 2023 - All Rights Reserved
        </p>
      </footer>
    </>
  );
